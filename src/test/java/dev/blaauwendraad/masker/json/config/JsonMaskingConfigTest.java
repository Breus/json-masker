...
final class JsonMaskingConfigTest {
    ...
    private static Stream<Supplier<JsonMaskingConfig.Builder>> invalidBuilders() {
        return Stream.of(
                ...
                () -> JsonMaskingConfig.builder()
                        .maskKeys(Set.of(), KeyMaskingConfig.builder().build()),
                ...
                () -> JsonMaskingConfig.builder()
                        .maskJsonPaths(Set.of(), KeyMaskingConfig.builder().build()),
                ...
                () -> JsonMaskingConfig.builder()
                        .maskStringsWith(ValueMaskers.with("***"))
                        .maskStringsWith(ValueMaskers.with("***")),
                ...
                () -> JsonMaskingConfig.builder()
                        .maskNumbersWith(ValueMaskers.with(0))
                        .maskNumbersWith(ValueMaskers.with(0)),
                () -> JsonMaskingConfig.builder()
                        .maskNumbersWith(ValueMaskers.with(0))
                        .maskNumbersWith("###"),
