...
public final class JsonStringCharacters {
    ...
    private static final Set<Character> asciiDigits =
            IntStream.rangeClosed(32, 57).mapToObj(i -> (char) i).collect(Collectors.toSet());
    private static final Set<Character> asciiSpecialChars1 =
            IntStream.rangeClosed(58, 64).mapToObj(i -> (char) i).collect(Collectors.toSet());
    ...
    private static final Set<Character> asciiSpecialChars2 =
            IntStream.rangeClosed(91, 96).mapToObj(i -> (char) i).collect(Collectors.toSet());
    private static final Set<Character> asciiLowercaseLetters =
            IntStream.rangeClosed(97, 122).mapToObj(i -> (char) i).collect(Collectors.toSet());
    private static final Set<Character> asciiSpecialChars3 =
            IntStream.rangeClosed(123, 126).mapToObj(i -> (char) i).collect(Collectors.toSet());
