 ...
 * <p>
 * {@link JsonMaskerAlgorithmType#SINGLE_TARGET_LOOP}   loops over the target key set and executes the single-target
 ...
 * {@link JsonMaskerAlgorithmType#KEYS_CONTAIN}         uses a dedicated multi-target algorithm by looking for a
 ...
 * Note: for small target key set (1-2 entries), the {@link JsonMaskerAlgorithmType#SINGLE_TARGET_LOOP} might
